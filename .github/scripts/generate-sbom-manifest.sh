...
#   CHANNEL          Store channel, such as 9.0/edge. The part after the slash
#                    is the channel name SSDLC wants. Default: 9.0/edge.
