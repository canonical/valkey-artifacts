...
This branch packages Valkey as three variants, each shipped both as a snap and as a rock (OCI image) built from that snap:
...
The snap and rock for a given variant share the same package name.
